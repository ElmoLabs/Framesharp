...
{
    public class CrudStatelessDomainService<T> : StatelessDomainServiceBase, ICrudStatelessDomainService<T> where T : class, IDomainObject
    {
        ...
        {
            return Repository.GetByCriteria(criteriaCollection);
        }
